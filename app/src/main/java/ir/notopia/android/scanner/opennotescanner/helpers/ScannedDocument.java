...
public class ScannedDocument {
    ...
    public ScannedDocument setCropped(Mat cropped) {
        this.cropped = cropped;
        return this;
    }

    public ScannedDocument setProcessedFilter(Mat processed) {
        this.processedFilter = processed;
        return this;
    }
